...
from LT_data import load_and_torch
...
def run_esn(INPUT_COLS, TARGET_COL, TRAIN_FRAC = 0.8, WASHOUT = 200, 
    ...
    U_train, U_test, Y_train, Y_test, stats = load_and_torch(DATA_PATH, INPUT_COLS, TARGET_COL, TRAIN_FRAC)
