...
class EchoStateNetwork:
    ...
    def __init__(self, n_inputs, n_reservoir, n_outputs, spectral_radius = 0.9, sparsity = 0.9, 
    ...
    def fit(self, U: torch.Tensor, Y: torch.Tensor, washout: int = 100):
    ...
    def predict(self, U: torch.Tensor, washout: int = 0):
